...
44 domain agents, 121 workflow skills, 86 hooks, 135 scripts. Agents carry knowledge, skills enforce methodology, hooks block incomplete work, scripts handle determinism.
...
| Skills | 121 | Phased methodology with gates. Can't skip steps. Each phase has exit criteria requiring evidence. |
| Hooks | 86 | Fire on lifecycle events. Block incomplete work. Zero LLM cost. |
| Scripts | 135 | Determinism: test runners, linters, validators. No LLM judgment. |

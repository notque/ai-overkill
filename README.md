...
44 domain agents, 120 workflow skills, 86 hooks, 133 scripts. Agents carry knowledge, skills enforce methodology, hooks block incomplete work, scripts handle determinism.
...
| Scripts | 133 | Determinism: test runners, linters, validators. No LLM judgment. |
